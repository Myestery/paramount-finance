...
*/
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var ma = /^(\/[a-zA-Z0-9_\-]+)+$/
      ...
      , ta = function(a, b, c, d, e) {
        var f = a.split(";")
          ...
          , l = O[k]
          , p = null;
        l ? p = l(f, b, c, d) : R("no hint processor for: " + k);
        p || R("failed to generate load url");
        b = p;
        c = b.match(qa);
        (d = b.match(ra)) && 1 === d.length && sa.test(b) && c && 1 === c.length || R("failed sanity: " + a);
        try {
            a = "?";
            if (e && 0 < e.length) {
                c = b = 0;
                for (d = {}; c < e.length; ) {
                    ...
                    f = void 0;
                    k = typeof q;
                    f = "object" == k && null != q || "function" == k ? "o" + (Object.prototype.hasOwnProperty.call(q, n) && q[n] || (q[n] = ++da)) : (typeof q).charAt(0) + q;
      ...
      , ua = function(a) {
        ...
        b = "/" + c.join("/");
        ma.test(b) || R("invalid_prefix");
        c = 0;
        for (d = S.length; c < d; ++c)
            S[c].test(b) && R("invalid_prefix");
        c = U(a, "k", !0);
        d = U(a, "am");
        e = U(a, "rs");
        a = U(a, "t");
    ...
    ;
    var V = decodeURI("%73cript"), W = /^[-+_0-9\/A-Za-z]+={0,2}$/, X = function(a, b) {
        ...
        var a = F.nonce;
        return void 0 !== a ? a && a === String(a) && a.match(W) ? a : F.nonce = null : y.querySelector ? (a = y.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "",
        a && a === String(a) && a.match(W) ? F.nonce = a : F.nonce = null) : null : null
    }, ya = function(a) {
        if ("loading" != y.readyState)
            xa(a);
        else {
            var b = wa()
              , c = "";
        ...
        var b = y.createElement(V);
        b.setAttribute("src", Y ? Y.createScriptURL(a) : a);
        a = wa();
        null !== a && b.setAttribute("nonce", a);
        b.async = "true";
        (a = y.getElementsByTagName(V)[0]) ? a.parentNode.insertBefore(b, a) : (y.head || y.body || y.documentElement).appendChild(b)
    }, Aa = function(a, b, c) {
        za(function() {
            var d = b === H() ? A(E, "_", D()) : D();
            d = A(I(b), "_", d);
        ...
        if (r.length) {
            ...
            if (r.length) {
                ...
                ;
                a = ta(c, r, "gapi." + Q, l, Ga);
                l.push.apply(l, r);
                N("ml0", r, K);
                b.sync || x.___gapisync ? ya(a) : xa(a)
            } else
                u[v](ha)
        } else
            ea(r) && d && d()
    ...
    window.gapi.load("", {
        callback: window["__iframefcb680637"],
        _c: {
